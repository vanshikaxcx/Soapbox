...
export function SearchPage() {
  ...
  const searchData = useMemo(
    () => ({ baskets: fixtureBaskets, evidence: fixtureEvidence }),
    [],
  );
  ...
  return (
    <div className="pp-page">
      ...
      <AsyncStateView
        state={state}
        emptyLabel="No baskets could be compared yet."
      >
        {(data, partial) => (
          <>
            {partial && (
              <p role="status">
                One source is still missing — showing what we have so far.
              </p>
            )}
