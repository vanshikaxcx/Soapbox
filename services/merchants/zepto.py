"""Zepto connector. Selectors are placeholders — confirm with scripts/spike_merchant.py
...
class ZeptoMerchant(PlaywrightMerchant):
    ...
    def _search_impl(self, page, location: Location, item: ItemQuery):
        ...
        page.fill('[data-testid="address-search-input"]', location.pincode)
            ...
            try:
                ...
                observations.append(
                    Observation(
                        ...
                        url=f"https://www.zeptonow.com{sku_url}",
                        product_name=name,
